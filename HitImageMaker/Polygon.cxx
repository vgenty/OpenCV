...
//------------------------------------------------------------------
// Polygon constructor returning intersection of 2 polygons
Polygon::Polygon(const Polygon &poly1, const Polygon &poly2)
{
...
//vic
//-----------------------------------------------------
int Polygon::LineCross(const std::pair<float,float> &point1,
...
float Polygon::InteriorAngle(unsigned int p) const {
