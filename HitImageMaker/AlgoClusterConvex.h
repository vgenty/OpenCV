...
#ifndef ALGOCLUSTERCONVEX_H
#define ALGOCLUSTERCONVEX_H
...
namespace larlite {
  ...
  class AlgoClusterConvex : public BaseAlgoCluster {
  ...
  public:
    ...
    ///Alternative ctor
    AlgoClusterConvex(const ::fcllite::PSet &pset);
    
    /// Default destructor
    virtual ~AlgoClusterConvex(){}
