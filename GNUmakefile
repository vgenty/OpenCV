...
#
SUBDIRS := Utils HitImageMaker #ADD_NEW_SUBDIR ... do not remove this comment from this line
...
doxygen:
	...
	@mkdir -p $(LARLITE_USERDEVDIR)/OpenCV/doc/dOxygenMyProject
	@doxygen $(LARLITE_USERDEVDIR)/OpenCV/doc/doxygenMyProject.script
